...
c.gisclean_file("something.csv", ["ISO3166"])
...
class CleanIndices(Frame):
    ...
    '''
    ======================================================================================
    Add columns containing GIS codes to a csv file
    
    inputs:
    * infile: input csv file. Assume that first column in this file is countryname
    * standards: list of standards that we want names cleaned to. Choices are:
     "ISO3166", "UNSTATS", "FIPS10", "STANAG"; format is [standard1, standard etc]
    outputs:
    * Cleaned file is output as tmpcleanfile.csv
    
    Sara-Jayne Farmer
    2012
    ======================================================================================
    '''
    def gisclean_file(self, infile, standards):
        ...
        #Copy the file headings (and add standard names)
        headers = csvIn.next()
        insert = []
        ...
        #Copy the file rows (and add standard codes to each row)
        for row in csvIn:
